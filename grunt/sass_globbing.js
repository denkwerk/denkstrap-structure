...
module.exports = function (grunt, options) {
    return {
        dist: {
            files: {
                '<%= srcPath %>components/sass/import/config.scss': '<%= srcPath %>components/sass/config/**/*.scss',
                ...
                '<%= srcPath %>components/sass/import/vendor.scss': '<%= srcPath %>components/sass/vendor/**/*.scss',
                '<%= srcPath %>components/sass/import/site.scss': '<%= srcPath %>components/sass/site/**/*.scss',
